...
class SeaRouteModel(Base):
    uid = ('company_id', 'container_id', 'start_point_id', 'end_point_id', 'effective_from', 'effective_to')
    ...
    filo: Mapped[Optional[float]] = mapped_column()
...
class RailRouteModel(Base):
    ...
    guard: Mapped[Optional[float]] = mapped_column()
